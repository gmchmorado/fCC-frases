...
const archivo = require('./citas.json');
const citas = archivo.citas;
const primerIndice = Math.floor(Math.random() * 50);
...
class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      randomIndex: 0,
      text: citas[primerIndice].text,
      author: citas[primerIndice].author
    };
  }
  ...
  cambiar () {
    this.setState({
      ...
      text: citas[this.state.randomIndex].text,
      author: citas[this.state.randomIndex].author
    })
  }
      ...
      <div className='main-container'>
        <div id='quote-box' className='quote-box'>
          ...
          <div className='quote-footer'>
            ...
            <button 
              id='new-quote'
              onClick={this.cambiar.bind(this)}>
              New quote
            </button>
          </div>
        </div>
